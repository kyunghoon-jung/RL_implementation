...
class QNetwork(nn.Module):
    ...
    def __init__(self, input_dim, action_dim, initial_std, rand_seed=False,
        ...
        self.V_noisy_linear2 = Noisy_LinearLayer(512, n_atoms, initial_std) # Dist. of Values
        self.A_noisy_linear1 = Noisy_LinearLayer(linear_input_size, 512, initial_std) 
        self.A_noisy_linear2 = Noisy_LinearLayer(512, action_dim*n_atoms, initial_std) # Dist. of Action-Values
